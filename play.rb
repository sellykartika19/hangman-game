class Hangman
  ...
  def words
    [
      ["penguin", "I have white belly"],
      ["strawberry", "There is a small green hat on my head"],
      ["micrometer", "I am used for measuring things"],
      ["microwave", "You program me to cook food"],
      ["paper", "I can be used to make things"],
    ]
  end
